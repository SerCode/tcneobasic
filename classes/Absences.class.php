...
class Absences
{
   ...
   {
      $records = array ();
      $query = $this->db->prepare('SELECT * FROM ' . $this->table . ' ORDER BY name ASC LIMIT 0,10');
      $result = $query->execute();
      if ($result)
      {
   ...
   {
      $records = array ();
      $query = $this->db->prepare('SELECT * FROM ' . $this->table . ' WHERE counts_as = :val1 ORDER BY name ASC LIMIT 0,10');
      $query->bindParam('val1', $id);
      $result = $query->execute();
      if ($result)
      {
   ...
   {
      $records = array ();
      $query = $this->db->prepare('SELECT * FROM ' . $this->table . ' WHERE id != :val1 AND counts_as = "0" ORDER BY name ASC LIMIT 0,10');
      $query->bindParam('val1', $id);
      $result = $query->execute();
   ...
   public function getByName($name = '')
   {
      ...
      if (isset($name))
      {
         $query = $this->db->prepare('SELECT * FROM ' . $this->table . ' WHERE name = :val1 LIMIT 0,10');

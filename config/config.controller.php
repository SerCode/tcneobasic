...
$CONF['controllers'] = array (
   ...
   'groupedit' => new Controller('groupedit', 'fas fa-users', $CONF['menuIconColor'], 'danger', 'groups', 'Group Edit', 'https://support.lewe.com/docs/teamcal-neo-manual/administration/groups/'),

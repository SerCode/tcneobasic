...
$LANG['abs_max_reached'] = 'You have reached the maximum amount of absence types ('.APP_MABS.') for TeamCal Neo Basic. Upgrade to the Pro version to get unlimited absence types.';
$LANG['abs_name'] = 'Name';
